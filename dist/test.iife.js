...
var Instruments = function() {
  ...
  const toDisplayString = (val) => {
    return isString(val) ? val : val == null ? "" : isArray(val) || isObject(val) && (val.toString === objectToString$2 || !isFunction(val.toString)) ? JSON.stringify(val, replacer, 2) : String(val);
  };
  ...
  Object.keys(events).map((internalName) => lodash_kebabcase(internalName));
  var isVue2 = false;
  /*!
    * pinia v2.0.12
  ...
  const useStoreRefs = (store = useStore()) => storeToRefs(store);
  ...
  const _sfc_main$7 = defineComponent({
    components: {
      MethodSelector: defineAsyncComponent(() => Promise.resolve().then(function() {
        return methodSelector$1;
      })),
      Confirmation: defineAsyncComponent(() => Promise.resolve().then(function() {
  ...
  function _sfc_render$7(_ctx, _cache, $props, $setup, $data, $options) {
    return openBlock(), createBlock(resolveDynamicComponent(_ctx.view));
  }
  var FormView = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["render", _sfc_render$7]]);
  const _sfc_main$6 = defineComponent({
    setup() {
      const { view } = useStoreRefs();
      return {
        view
      };
    }
  });
  const _hoisted_1$6 = /* @__PURE__ */ createBaseVNode("h1", null, "hello world", -1);
  function _sfc_render$6(_ctx, _cache, $props, $setup, $data, $options) {
    return openBlock(), createElementBlock(Fragment, null, [
      _hoisted_1$6,
      createBaseVNode("p", null, "view: " + toDisplayString(_ctx.view), 1)
    ], 64);
  }
  var SummaryView = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["render", _sfc_render$6]]);
  class Instruments2 {
    constructor() {
    ...
    async mount({
      ...
      createApp(FormView).use(this.state).mount(form);
      if (summary) {
        createApp(SummaryView).use(this.state).mount(summary);
      }
      this.on("instrument-ready", () => {
        const form2 = useStore();
        form2.changeView("Confirmation");
      });
    }
    on(eventName, callback) {
      const internalEventName = lodash_camelcase(eventName);
      events[internalEventName].addEventListener(callback);
    }
  }
  const instrument = new Instruments2();
  const _sfc_main$5 = defineComponent({
    components: {
      PaymentCard: defineAsyncComponent(() => Promise.resolve().then(function() {
        return paymentCard$1;
      })),
      BankAccount: defineAsyncComponent(() => Promise.resolve().then(function() {
        return bankAccount$1;
      })),
      GooglePay: defineAsyncComponent(() => Promise.resolve().then(function() {
        return googlePay$1;
      })),
      Paypal: defineAsyncComponent(() => Promise.resolve().then(function() {
        return paypal$1;
      }))
    },
    setup() {
  ...
  const _hoisted_2$4 = ["open"];
  const _hoisted_3$4 = ["open"];
  function _sfc_render$5(_ctx, _cache, $props, $setup, $data, $options) {
    const _component_paypal = resolveComponent("paypal");
    const _component_google_pay = resolveComponent("google-pay");
    const _component_payment_card = resolveComponent("payment-card");
    const _component_bank_account = resolveComponent("bank-account");
    return openBlock(), createElementBlock(Fragment, null, [
      createBaseVNode("div", null, [
        createVNode(_component_paypal),
        createVNode(_component_google_pay)
      ]),
      _hoisted_1$5,
      createBaseVNode("details", {
        class: "rebilly-instruments-accordion",
        open: _ctx.selectedMethod === "payment-card"
      }, [
        createBaseVNode("summary", {
          onClick: _cache[0] || (_cache[0] = withModifiers(($event) => _ctx.selectedMethod = "payment-card", ["prevent"]))
        }, "Payment Card"),
        _ctx.selectedMethod === "payment-card" ? (openBlock(), createBlock(_component_payment_card, { key: 0 })) : createCommentVNode("", true)
      ], 8, _hoisted_2$4),
      createBaseVNode("details", {
        class: "rebilly-instruments-accordion",
        open: _ctx.selectedMethod === "bank-account"
      }, [
        createBaseVNode("summary", {
          onClick: _cache[1] || (_cache[1] = withModifiers(($event) => _ctx.selectedMethod = "bank-account", ["prevent"]))
        }, "Bank Account"),
        _ctx.selectedMethod === "bank-account" ? (openBlock(), createBlock(_component_bank_account, { key: 0 })) : createCommentVNode("", true)
      ], 8, _hoisted_3$4)
    ], 64);
  }
  var methodSelector = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["render", _sfc_render$5]]);
  var methodSelector$1 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
    __proto__: null,
    "default": methodSelector
  ...
  const _hoisted_1$4 = /* @__PURE__ */ createBaseVNode("h1", null, "Confirmation", -1);
  function _sfc_render$4(_ctx, _cache, $props, $setup, $data, $options) {
    return openBlock(), createElementBlock("div", null, [
      _hoisted_1$4,
      createBaseVNode("a", {
        onClick: _cache[0] || (_cache[0] = withModifiers(($event) => _ctx.changeView("MethodSelector"), ["prevent"]))
      }, "\u2190 Choose another instrument")
    ]);
  }
  var confirmation = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["render", _sfc_render$4]]);
  var confirmation$1 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
    __proto__: null,
    "default": confirmation
  }, Symbol.toStringTag, { value: "Module" }));
  const useInstrumentTokenStore = defineStore("PaymentInstrumentToken", {
    state: () => ({}),
    actions: {
      setToken(fields) {
    ...
    getters: {
      ...
      isGooglePayToken() {
        var _a;
        return this.method === "digital-wallet" && ((_a = this.paymentInstrument) == null ? void 0 : _a.type) === "Google Pay";
      }
    }
  });
  const _sfc_main$3 = defineComponent({
    ...
    methods: {
      async submit() {
        ...
        events.instrumentReady.dispatch({
          _raw: this.token
        });
      }
    }
  ...
  const _hoisted_3$3 = /* @__PURE__ */ createBaseVNode("div", { id: "payment-card" }, null, -1);
  function _sfc_render$3(_ctx, _cache, $props, $setup, $data, $options) {
    return openBlock(), createElementBlock("form", _hoisted_1$3, [
      _hoisted_2$3,
      _hoisted_3$3,
      createBaseVNode("button", {
        onClick: _cache[0] || (_cache[0] = withModifiers((...args) => _ctx.submit && _ctx.submit(...args), ["prevent"]))
      }, "Submit")
    ], 512);
  }
  var paymentCard = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["render", _sfc_render$3]]);
  var paymentCard$1 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
    __proto__: null,
    "default": paymentCard
  }, Symbol.toStringTag, { value: "Module" }));
  ...
  const _hoisted_1$2 = { class: "rebilly-instruments-form" };
  const _hoisted_2$2 = /* @__PURE__ */ createBaseVNode("div", { id: "rebilly-instruments-account-type" }, null, -1);
  const _hoisted_3$2 = /* @__PURE__ */ createBaseVNode("p", null, "Account Number: ", -1);
  const _hoisted_4 = /* @__PURE__ */ createBaseVNode("div", { id: "rebilly-instruments-account-number" }, null, -1);
  const _hoisted_5 = /* @__PURE__ */ createBaseVNode("p", null, "Routing Number: ", -1);
  const _hoisted_6 = /* @__PURE__ */ createBaseVNode("div", { id: "rebilly-instruments-routing-number" }, null, -1);
  ...
  var bankAccount = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["render", _sfc_render$2]]);
  var bankAccount$1 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
    __proto__: null,
    "default": bankAccount
  }, Symbol.toStringTag, { value: "Module" }));
  const _sfc_main$1 = defineComponent({
    setup() {
      const Rebilly = shallowRef(null);
      const googlePay2 = shallowRef(null);
      const googlePayForm = ref();
      const token = useInstrumentTokenStore();
      onMounted(() => {
        const { Rebilly: RebillyInstance } = useFramePay();
        RebillyInstance.on("ready", () => {
          googlePay2.value = RebillyInstance.googlePay.mount("#google-pay", {
            type: "googlePay",
            form: googlePayForm
          });
        });
        RebillyInstance.on("token-ready", (fields) => {
          ...
          if (token.isGooglePay) {
            events.instrumentReady.dispatch({ _raw: token });
          }
        });
        Rebilly.value = RebillyInstance;
      });
      onBeforeUnmount(() => {
        googlePay2.value.destroy();
      });
      return {
        Rebilly,
        googlePayForm
  ...
  const _hoisted_2$1 = /* @__PURE__ */ createBaseVNode("div", { id: "google-pay" }, null, -1);
  const _hoisted_3$1 = [
    _hoisted_2$1
  ];
  function _sfc_render$1(_ctx, _cache, $props, $setup, $data, $options) {
    return openBlock(), createElementBlock("form", _hoisted_1$1, _hoisted_3$1, 512);
  }
  var googlePay = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render$1]]);
  var googlePay$1 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
    __proto__: null,
    "default": googlePay
  }, Symbol.toStringTag, { value: "Module" }));
  const _sfc_main = defineComponent({
    setup() {
      const Rebilly = shallowRef(null);
      const paypal2 = shallowRef(null);
      const token = useInstrumentTokenStore();
      onMounted(() => {
        const { Rebilly: RebillyInstance } = useFramePay();
        RebillyInstance.on("ready", () => {
          paypal2.value = RebillyInstance.paypal.mount("#pay-pal");
        });
        RebillyInstance.on("token-ready", (fields) => {
          token.setToken(fields);
          if (token.isPaypal) {
  ...
  const _hoisted_2 = /* @__PURE__ */ createBaseVNode("div", { id: "pay-pal" }, null, -1);
  const _hoisted_3 = [
    _hoisted_2
  ];
  function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
    return openBlock(), createElementBlock("form", _hoisted_1, _hoisted_3, 512);
  }
  var paypal = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render]]);
  var paypal$1 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
    __proto__: null,
    "default": paypal
  }, Symbol.toStringTag, { value: "Module" }));
  return instrument;
